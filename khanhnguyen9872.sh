...
sudo qemu-system-x86_64 -hda khanhnguyen9872.qcow2 -smp cores=2 -m 10G -machine usb=on -device usb-tablet -device rtl8139,netdev=n0 -netdev user,id=n0 -vnc :9872 > /dev/null 2>&1
echo ""
echo "Your IP Here: "
cat /proc/cpuinfo
