...
if [ ! -f khanhnguyen9872.vhd ] 2> /dev/null; then
  ...
  sudo qemu-system-x86_64 -hda khanhnguyen9872.vhd -cpu Haswell -smp cores=2 -m 10G -vga vmware -machine usb=on -device usb-tablet -device rtl8139,netdev=n0 -netdev user,id=n0 -vnc :0
  echo ""
  echo "Your IP Here: "
