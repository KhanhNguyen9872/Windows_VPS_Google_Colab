...
def _setupSSHDImpl(ngrok_token, ngrok_region, is_VNC):
  ...
  if not os.path.exists('ngrok.zip'):
    _download("https://github.com/KhanhNguyen9872/Windows_VPS_Google_Colab/blob/main/ngrok-stable-linux-amd64.zip?raw=true", "ngrok.zip")
...
def apps():
  !wget -O microemulator.jar https://github.com/KhanhNguyen9872/Windows_VPS_Google_Colab/blob/main/microemulator.jar?raw=true
  !mv microemulator.jar /usr/bin
  !wget -O MicroEmulator.sh https://raw.githubusercontent.com/KhanhNguyen9872/Windows_VPS_Google_Colab/main/MicroEmulator.sh
  !mv MicroEmulator.sh /usr/bin/microemulator
  !wget -O MicroEmulator.desktop https://raw.githubusercontent.com/KhanhNguyen9872/Windows_VPS_Google_Colab/main/MicroEmulator.desktop
  !mv MicroEmulator.desktop /home/colab/Desktop
  !chmod 777 /usr/bin/microemulator.jar /usr/bin/microemulator /home/colab/Desktop/MicroEmulator.desktop
  !sudo apt --purge remove openjdk-11-jre -y
  clear_output()
  my_apt = _MyApt()
  my_apt.installPkg("firefox", "xarchiver", "mesa-utils", "xfce4", "xfce4-goodies", "openjdk-11-jre")
  my_apt.commit()
  clear_output()
